                                  ...
                                  itemBuilder: (ctx, index) {
                                    return GestureDetector(
                                      onTap: () async {
                                        ...
                                        if (subCategoryController.subCategoryList[index].subCategories > 0) {
                                          final result = await Get.toNamed(Routes.subSubCategoryScreen,
                                              arguments: {
                                                'id': subCategoryController.subCategoryList[index].id.toString(),
                                                'title': subCategoryController.subCategoryList[index].name,
                                              });
                                          subCategoryController.fetchSubCategories(categoryId: id);
