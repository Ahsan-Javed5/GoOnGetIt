...
class Spaces {
  ...
  static Widget x11 = SizedBox(width: 11.0.w);
  static Widget x12 = SizedBox(width: 12.0.w);
  static Widget x13 = SizedBox(width: 13.0.w);
  static Widget x14 = SizedBox(width: 14.0.w);

  /// User these widgets for space along Y-Axis (for height)
  static Widget y0_5 = SizedBox(height: 0.1.h);
  static Widget y0 = SizedBox(height: 0.5.h);
  static Widget y1 = SizedBox(height: 1.0.h);
  static Widget y1_05 = SizedBox(height: 1.5.h);
  ...
  static Widget y11 = SizedBox(height: 11.0.h);
  static Widget y12 = SizedBox(height: 12.0.h);
